...
<section class="space-default featured">
	<div class="container" ng-controller="appCtrl">
		<h2 class=" title-descr tab-bottom font-poppins">Monte seu site</h2>
		<form class="form" method="post">
			...
			<p>Selecione o que você gostaria de ter no seu site.</p>
			...
			<div class="space-bottom">
				<div class="owl-carousel components">
					...
					<section class="space-default local title-middle overlay">
						<input type="radio" class="hidden" name="local" value="2">
						<div class="container">
							<div class="column">
								<div class="sm-4-12">
									<div class="local-item a-center bordered">
										<h2 class="font-dancing title-event a-center">Cerimônia Principal</h2>
										<div class="local-details">
			...
			<!-- <h3 class="components-title">Página de Recados</h3> -->
			<div class="owl-carousel components">
				...
				<section class="space-default notes overlay box">
					...
					<div class="container">
						<h2 class="title-doc a-center">Página de Recados</h2>
				...
				<section class="space-defaut notes box with-pic">
			...
			<div class="owl-carousel components space-default">
				<div class="containr">
			...
			<button type="submit" class="btn btn-theme">Criar site</button>
		</form>
	</div>
